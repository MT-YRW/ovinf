...
#ifndef OVINF_HUMANOIDINS_H
#define OVINF_HUMANOIDINS_H
 ...
 */
class HumanoidInsPolicy : public BasePolicy<float> {
 ...
 public:
  HumanoidInsPolicy() = delete;
  ~HumanoidInsPolicy();

  HumanoidInsPolicy(const YAML::Node &config);
