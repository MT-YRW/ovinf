...
#ifndef OVINF_HUMANOIDTCA_H
#define OVINF_HUMANOIDTCA_H
 ...
 */
class HumanoidTCAPolicy : public BasePolicy<float> {
 ...
 public:
  HumanoidTCAPolicy() = delete;
  ~HumanoidTCAPolicy();

  HumanoidTCAPolicy(const YAML::Node &config);
